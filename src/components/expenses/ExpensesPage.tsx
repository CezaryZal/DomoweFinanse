...
export function ExpensesPage({ expenses, categories, onAdd, onDelete }: { expenses: Expense[]; categories: Category[]; onAdd: () => void; onDelete: (id: string) => void }) {
